 ...
 */
public class Fensi_Fragment extends Fragment {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(getActivity()).load(Data_Util.IMG+fensi_list.get(position).getHeadImg()).into(iv_head);
