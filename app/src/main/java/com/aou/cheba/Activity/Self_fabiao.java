 ...
 */
public class Self_fabiao extends SwipeBackActivity {

    List<MyCode_data.ObjBean> list_shoucang = new ArrayList<>();
    private int rows;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.self_fabiao);
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            vParams1.height = (int) (DisplayUtil.getMobileHeight(Self_fabiao.this) * Data_Util.HEAD_NEW);
            ll_home.setLayoutParams(vParams1);
        } else {
            ViewGroup.LayoutParams vParams1 = ll_home.getLayoutParams();
            vParams1.height = (int) (DisplayUtil.getMobileHeight(Self_fabiao.this) * Data_Util.HEAD_OLD);
            ll_home.setLayoutParams(vParams1);
        }
        ...
        inithttp_data(SPUtils.getString(Self_fabiao.this, "token"), 9223372036854775807l);
    }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!isenter) {
                    ...
                    if (position != list_shoucang.size()) {
                        ...
                        MyCode_data.ObjBean objBean = list_shoucang.get(position);
                        Utils.i(objBean.getType() + "  " + objBean.getTitle());
                        if (objBean.getType() == 9 && (objBean.getTitle() != null && objBean.getTitle().length() != 0)) {
                            Intent intent = new Intent(Self_fabiao.this, HuaTi_WenDa_Activity.class);
                            intent.putExtra("position", position);
                            intent.putExtra("ser", objBean);
                            startActivity(intent);
                        } else {
                            Intent intent = new Intent(Self_fabiao.this, HuaTi_Activity.class);
    ...
    private void initData() {
        ...
        mLoadMoreListView.setOnLoadMoreListener(new LoadMoreListView.OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                inithttp_data(SPUtils.getString(Self_fabiao.this, "token"), list_shoucang.get(list_shoucang.size() - 1).getAddtime());
            }
        });
    }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(Self_fabiao.this, R.layout.shoucang_item, null);
            ...
            if (list_shoucang.get(position).getPictrue() != null && !TextUtils.isEmpty(list_shoucang.get(position).getPictrue())) {
                ...
                Glide.with(Self_fabiao.this).load(Data_Util.IMG + list_shoucang.get(position).getPictrue().split(",")[0]).into(viewHolder.iv_image);
            ...
            Utils.i(list_shoucang.get(position).getAddtime() + "  " + yue);
            if (yue.substring(0, 1).equals("0")) {
                viewHolder.tv_yue.setText(yue.substring(1, 2) + " 月");
            } else {
                viewHolder.tv_yue.setText(yue + " 月");
            }
            viewHolder.tv_ri.setText(TimeUtil.getDateTimeFromMillisecond4(list_shoucang.get(position).getAddtime()));
        ...
        public void onClick(final View v) {
            ...
            switch (v.getId()) {
                case R.id.iv_finish:
                    ...
                    break;
                case R.id.iv_delete:
                    new SweetAlertDialog(Self_fabiao.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    inithttp_delete(list_shoucang.get(tag).getId(), tag);
    ...
    private void inithttp_data(String token, final Long addtime) {
        ...
        rows = 15;
        RequestBody requestBody = RequestBody.create(JSON, "{\"obj\": { \"addtime\": " + addtime + "},\"token\": \"" + token + "\"}");
//创建一个请求对象
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MyToast.showToast(Self_fabiao.this, "连接服务器失败");
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (mycode.getCode() == 0) {
                            if (addtime == 9223372036854775807l) {
                                list_shoucang.clear();
                            ...
                            mRefreshAndLoadMoreView.setRefreshing(false);
                            mLoadMoreListView.onLoadComplete();
                            MyToast.showToast(Self_fabiao.this, "刷新失败");
                        }
                    }
                }, 500);
            }
    ...
    private void inithttp_delete(long id, final int posi) {
        OkHttpClient okHttpClient =
                new OkHttpClient.Builder()
                        .connectTimeout(5000, TimeUnit.SECONDS)//设置连接超时时间
                        .build();
        ...
        RequestBody requestBody = RequestBody.create(JSON, "{\"obj\":{\"id\":" + id + ",\"uid\": " + SPUtils.getString(Self_fabiao.this, "uid") + "}}");
//创建一个请求对象

        Request request = new Request.Builder()
                .url(Data_Util.HttPHEAD + "/Carbar/User!DataDeleteByUid.action")
                .post(requestBody)
                .build();
        Call call = okHttpClient.newCall(request);
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        if (mycode.getCode() == 0) {
                            list_shoucang.remove(posi);
                            myAdapter.notifyDataSetChanged();
                        } else {
                            MyToast.showToast(Self_fabiao.this, "删除失败");
                        }
                    }
                });
            }
