...
import com.aou.cheba.Fragment.Other_Fensi_Fragment;
import com.aou.cheba.Fragment.Other_Guanzhu_Fragment;
...
public class Other_GuanZhu_Activity extends SwipeBackActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            vParams1.height = (int) (DisplayUtil.getMobileHeight(Other_GuanZhu_Activity.this) * Data_Util.HEAD_NEW);
            ll_home.setLayoutParams(vParams1);
        } else {
            ViewGroup.LayoutParams vParams1 = ll_home.getLayoutParams();
            vParams1.height = (int) (DisplayUtil.getMobileHeight(Other_GuanZhu_Activity.this) * Data_Util.HEAD_OLD);
            ll_home.setLayoutParams(vParams1);
        }

        ll_fensi.setOnClickListener(this);
        ll_guanzhu.setOnClickListener(this);
        fragments.add(new Other_Guanzhu_Fragment());
        fragments.add(new Other_Fensi_Fragment());
