 ...
 * android banner图
 */
public class RollHeaderView_yuetu extends FrameLayout implements OnPageChangeListener, View.OnClickListener {
    ...
    public RollHeaderView_yuetu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RollHeaderView_yuetu(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        View.inflate(mContext, R.layout.view_header_yuetu, this);
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
           ...
           /* iv.setOnLongClickListener(new OnLongClickListener() {
            ...
            iv.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    headerViewClickListener.toDetail(position % mUrlList.size());
                }
            });
